    ...
    client.newCall(request).enqueue(object : Callback {
        ...
        override fun onResponse(call: Call, response: Response) {
            if (response.isSuccessful) {
                ...
                val radiusResult = StreamResult(File("../../../../res/values/atom_radius.xml"))
                transformer.transform(radiusSource, radiusResult)

                val spacingSource = DOMSource(spacingDoc)
                val spacingResult = StreamResult(File("../../../../res/values/atom_spacing.xml"))
                transformer.transform(spacingSource, spacingResult)

                val colorSource = DOMSource(colorDoc)
                val colorResult = StreamResult(File("../../../../res/values/atom_colors.xml"))
