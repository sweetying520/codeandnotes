...
class ExampleUnitTest {
    ...
    fun generateFile(){
        ...
        val request = Request.Builder()
            .url("https://raw.githubusercontent.com/motaionx/figmaStyle/main/tokens.json") // 替换为你要请求的 JSON 文件的 URL
            .build()
            ...
            override fun onResponse(call: Call, response: Response) {
                    if (response.isSuccessful) {
                        ...
                        secondLevel.forEach {
                            ...
                            Log.d("erdai", "onResponse: $key ===> ${thirdLevel["value"]} ===> $type")
                            when(type){
                                "borderRadius" ->{
                                    //圆角
                        ...
                        borderRadiusMap.forEach {
                            ...
                            radiusElement.textContent = it.value
                        ...
                        spacingMap.forEach {
                            ...
                            spacingElement.textContent = it.value
                        ...
                        //4、添加 Radius 项
                        colorMap.forEach {
                            val colorElement = colorDoc.createElement("dimen")
